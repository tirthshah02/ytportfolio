const VIDEOS = [
  {
    ...
    channelInitials: "D61",
    channelColor: "#dc1e28",
    channel: "Driver61 | 1.43M subscribers | CTR 4.1% to 5.8%",
    title: "Driver61 - packaging overhaul that grew views 42%",
    stats: "1.43M subscribers | CTR 4.1% to 5.8%",
  ...
  },
  {
    ...
    channelInitials: "SL",
    channelColor: "#2563eb",
    channel: "Snazzy Labs | 1.6M subscribers | 1.2M new views",
    title: "Snazzy Labs - 200+ thumbnails redesigned, CTR 2.4% to 5.5%",
    stats: "1.6M subscribers | 1.2M new views",
  ...
  },
  {
    ...
    channelInitials: "DF",
    channelColor: "#16a34a",
    channel: "DesFit | 380K subscribers | +34% CTR lift",
    title: "DesFit - title formula overhaul drove 34% CTR lift",
    stats: "380K subscribers | +34% CTR lift",
  ...
  },
  {
    ...
    channelInitials: "VQ",
    channelColor: "#d97706",
    channel: "vidIQ | 1M+ subscribers | 63% avg retention",
    title: "vidIQ - scripting framework behind 4.2M views and 63% retention",
    stats: "1M+ subscribers | 63% avg retention",
  ...
  },
  {
    ...
    channelInitials: "MC",
    channelColor: "#7c3aed",
    channel: "Lumicus, AboveTheGoal, CreatorRant + more | 6 channels | 400+ A/B tests",
    title: "What 400+ A/B tests across 6 channels taught me about packaging",
    stats: "6 channels | 400+ A/B tests",
  ...
  },
  {
    ...
    channelInitials: "JH",
    channelColor: "#92400e",
    channel: "James Hoffmann | 2.4M subscribers | +58% on legacy views",
    title: "James Hoffmann - back-catalogue repackage drove 58% lift",
    stats: "2.4M subscribers | +58% on legacy views",
      ...
      <div class="thumbnail-wrap" style="background:${v.color}">
        ${v.thumbnail
          ...
          : `<div class="thumbnail-placeholder">
              ...
              <div style="font-size:12px; color:${v.accent};
              font-weight:600; text-transform:uppercase;
              letter-spacing:1px">${v.tags[0]}</div>
             </div>`
        }
...
function handleEasterEggClick() {
  document.getElementById('easterEggPopup').classList.add('hidden');
  showPage('about');
  document.querySelectorAll('.sidebar-item').forEach(i => i.classList.remove('active'));
  document.getElementById('nav-about').classList.add('active');
}

// Close popup if user clicks anywhere outside it
